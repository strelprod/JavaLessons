 ...
 * @author strel
 */
@WebServlet(name = "Calculator_2", urlPatterns = {"/calc_2"})
public class Calculator_2 extends HttpServlet{

    @Override
    public void init() throws ServletException {
        super.init(); 
        System.out.println("Servlet \"Calculator_2\" initialization is completed.");
    }

    @Override
    public void destroy() {
        System.out.println("Servlet \"Calculator_2\" is destroyed.");
        super.destroy(); 
    }
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        System.out.println("Servlet \"Calculator_2\" is serviced.");
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       // try(PrintWriter out = resp.getWriter()){
            ...
            if (error) 
                req.setAttribute("calcResult", errorMsg);
            else
                req.setAttribute("calcResult", result);
            
            //перенаправляем запрос на иcходную страницу, добавляя параметр calcResult
